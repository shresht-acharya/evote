...
contract Election {
    ...
    constructor () public {
        addCandidate("Kunal Bhosale","PMGP");
        addCandidate("Shresht Acharya","MRA");
        addCandidate("Ganesh Reddy","MBNR");
        addCandidate("Deepak Tiwari","UPB");
        addCandidate("Ashally Tuscano","CHR");
